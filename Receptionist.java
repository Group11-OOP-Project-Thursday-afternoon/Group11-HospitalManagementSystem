...
public class Receptionist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "RECEPTIONIST", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24), new java.awt.Color(0, 153, 204))); // NOI18N
        jPanel3.setLayout(null);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RECETIONISTDETAILS.png"))); // NOI18N
        jPanel3.add(jLabel1);
        ...
        jPanel3.add(jLabel8);
        jLabel8.setBounds(220, 290, 70, 30);
        jPanel3.add(ward);
        ward.setBounds(300, 290, 250, 30);
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "RECEPTIONIST ID ", "NAME", "WARD", "PHONE"
            }
        ));
        ...
        jButton9.setBounds(10, 250, 50, 50);
    ...
    public boolean idCheck() throws Exception {
        ...
        PreparedStatement pst = conn.prepareStatement("Select*From Receptionist where RecepID = ?");
    ...
    public void showTable() {
        try {
            conn = db.getConnection();
            PreparedStatement pst = conn.prepareStatement("select RecepID, Name,Ward,PhoneNo from Receptionist");
            ResultSet rs = pst.executeQuery();
            tableModel.setRowCount(0);
            while (rs.next()) {
                tableModel.addRow(new Object[]{rs.getString("RecepID"), rs.getString("Name"), rs.getString("Ward"), rs.getString("PhoneNo")});
            }
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            if (idCheck()) {
                try {
                    conn = db.getConnection();
                    String sql = " Insert into Receptionist(RecepID,Name,Age,PhoneNo,"
                            + "Gender,Address,Ward,JoiningDate,Image)"
                            + "values(?,?,?,?,?,?,?,?,?)";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            conn = db.getConnection();
            PreparedStatement pst2 = conn.prepareStatement("Delete from Receptionist Where StaffID =?");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try {
            conn = db.getConnection();
            PreparedStatement pst = conn.prepareStatement("UPDATE Receptionist SET "
                    + "Name = ?,Age=?,PhoneNo=?, Gender =?,Address=?,Ward=?,"
                    + "JoiningDate=?,Image=? WHERE RecepID =?");
