...
public class patient2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel2);
        jLabel2.setBounds(240, 40, 170, 30);
        jPanel3.add(id);
        ...
        jLabel4.setText("AGE");
        jPanel3.add(jLabel4);
        jLabel4.setBounds(670, 280, 40, 17);
        jPanel3.add(age);
        age.setBounds(750, 270, 120, 30);

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 153, 204));
        jLabel5.setText("GENDER");
        jPanel3.add(jLabel5);
        jLabel5.setBounds(650, 220, 60, 30);

        gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Others" }));
        jPanel3.add(gender);
        gender.setBounds(750, 220, 120, 30);
        ...
        jPanel3.add(jLabel7);
        jLabel7.setBounds(200, 330, 70, 30);
        jPanel3.add(address);
        address.setBounds(300, 330, 580, 30);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 153, 204));
        jLabel8.setText("PATIENT TYPE");
        jPanel3.add(jLabel8);
        jLabel8.setBounds(610, 110, 110, 30);

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 153, 204));
        jLabel9.setText("BLOOD GROUP");
        jPanel3.add(jLabel9);
        jLabel9.setBounds(610, 170, 110, 30);
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PATIENT'S ID ", "NAME", "TYPE", "PHONE", "BLOOD GROUP", "ADDRESS"
            }
        ));
        jScrollPane1.setViewportView(table);

        jPanel3.add(jScrollPane1);
        jScrollPane1.setBounds(220, 390, 1020, 170);
     ...
     private void showTable(){
        try {
            ...
            PreparedStatement pst = conn.prepareStatement("select PatientID, Name,"
                    + "PatientType,PhoneNo,BloodGroup,Address from Patient");
            ResultSet rs = pst.executeQuery();
            tableModel.setRowCount(0);
            while (rs.next()) {
                tableModel.addRow(new Object[]{rs.getString("PatientID"), rs.getString("Name"),
                    rs.getString("PatientType"), rs.getString("PhoneNo"),
                    rs.getString("BloodGroup"),rs.getString("Address")});
            }
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        try {
            if(idCheck()){
                conn = db.getConnection();
                String sql = " Insert into Patient (PatientID, Name, Age,Gender,"
                + "MaritialStatus,PhoneNo,Address,PatientType,BloodGroup,"
                + "Relatives,Image) values(?,?,?,?,?,?,?,?,?,?,?)";
                ...
                pst.setString(8, (String) type.getSelectedItem());
                pst.setString(9, (String) blood.getSelectedItem());
                pst.setString(10, relative.getText());
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            conn = db.getConnection();
            PreparedStatement pst2 = conn.prepareStatement("Delete from Patient Where PatientID =?");
