...
public class receptionistLogin extends javax.swing.JFrame {
    ...
    private static boolean isPasswordCorrect(char[] input) {
        ...
        char[] correctPassword = {'r', 'e', 'c', 'e', 'p','t','i','o','n','i','s','t'};
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (user.equals("receptionist") && isPasswordCorrect(password)) {
            this.dispose();
            rec.setVisible(true);
            
        } else {
            JOptionPane.showMessageDialog(this, "Incorrect Receptionist Username or Password");
        }
